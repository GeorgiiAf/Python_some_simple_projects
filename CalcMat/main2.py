...
url = "https://textarchive.ru/c-1076419.html"
...
for p in text_block.find_all("p"):  # Перебор всех параграфов
    ...
    for img in images:
        ...
        img_name = os.path.join("images2", os.path.basename(img['src']))
    ...
    tasks2.append({"text": text, "images": img_paths})
...
with open("tasks2.json", "w", encoding="utf-8") as f:
    json.dump(tasks2, f, ensure_ascii=False, indent=4)
